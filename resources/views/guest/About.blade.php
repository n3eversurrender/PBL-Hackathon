    ...
    <div class="bg-white py-24 sm:py-10">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-5xl lg:text-center">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-600">Unlock key advantages that will enchance your learning
...
<div class="container mx-auto">
    ...
    <div class="flex justify-center">
        ...
        <div class="w-full h-96 p-2">
            <!-- Card dengan lebar penuh dan tinggi 96 -->
            <div
                class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-full overflow-hidden">
                <!-- Menambahkan overflow-hidden untuk memastikan rounding bekerja -->
                <div class="relative h-full">
                    <!-- Menjaga tinggi tetap dan menempatkan gambar di dalam -->
                    <img class="w-full h-full object-cover rounded-t-lg" src="{{ asset('image/wle.png') }}"
                        alt="product image" />
                    ...
                    <div class="absolute left-24 bottom-1/2 transform translate-y-1/2">
                        <!-- Mengatur posisi tombol dan teks di kiri tengah -->
                        <p class="text-white text-2xl font-bold mb-5">Join SkillBridge</p>
                        <!-- Teks di atas tombol dengan warna putih -->
